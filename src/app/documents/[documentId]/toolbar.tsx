...
const FontSizeButton = () => {
  ...
  return (
    <div className="flex items-center gpa-x-0.5">
      <button
        onClick={decrement}
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-center border border-neutral-400 rounded-sm bg-transparent focus:outline-none focus:ring-0"
        />
      ) : (
        <button
          onClick={() => {
          ...
          className="h-7 w-10 text-center border border-neutral-400 rounded-sm bg-transparent cursor-text"
        >
          {currentFontSize}
        </button>
      )}
...
const HeadingLevelButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 min-w-[140px] shrink-0 flex items-center justify-between rounded-sm hover:bg-neutral-200/80 px-2 overflow-hidden text-sm">
    ...
    [
      ...
      },
      {
        ...
        onClick: () => {
          ...
          dom.setAttribute("spellcheck", newValue);
        },
      },
    ],
    [
